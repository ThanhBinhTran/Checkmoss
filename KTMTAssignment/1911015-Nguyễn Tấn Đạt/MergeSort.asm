.data
iArray: .word  -15  -84   60  -45   90   58   69   95   68   26  100  -89   70   30  -76   50   72  -55   -4   66
iLeft: .word 0:19
iRight: .word 0:19
size: .word 20
space: .asciiz " "
...
######
mergeSort:
#luu cac gia tri a0, a1, ra, tim middle va luu lai
#a0 la dia chi bat dau
#a1 la so luong  phan tu
addi $sp $sp -16
sw $ra, 12($sp)
sw $a0, 8($sp)	#dia chi cua mang
sw $a1, 4($sp) #Kích thuoc mang
		#0(sp) là vi tri middle + 1
# address of first ele in array
# index of first and end
sub $t1, $a1, 1
blez $t1, mergeReturn	
srl $t1, $t1, 1		
add $t1, $t1, 1
...
#Tai day a1 la middle + 1
# a0 van la dia chi bat dau

jal mergeSort		#sort the first half

lw $a1, 0($sp)		#a1 tro thành middle + 1
lw $t2, 4($sp)		#t2 là kich thuoc mang 
sub $a1, $t2, $a1	# a1 is size of the right half

lw $a0, 8($sp)		#a0 là vi trí cua mang
lw $t2, 0($sp)		#Gia tri middle + 1
sll $t2, $t2, 2
...
sub $a2, $a2, 1
sll $a2, $a2, 2
add $a2, $a0, $a2	#a2 points to arr[end]
